...
public class RecPositionUtil {
    ...
    public ArrayList<PositionCompanyBO> recommend(HashMap<Integer, Integer> map, UserModel user) {
        ...
        //应聘记录
        ArrayList<ApplicationModel> listPos = posConst.applicationMapper.listApplicationAll(resumeId);
        //评论记录
        ArrayList<CommentModel> listCom = posConst.commentMapper.listCommentAll(userId);
        //收藏记录
        ArrayList<FavorModel> listCol = posConst.favorMapper.listFavor(userId);
